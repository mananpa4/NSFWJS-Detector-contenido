...
require_once('includes/functions_profanity.php');
require_once('includes/functions_embed.php');
...
require_once('includes/chismy_content_moderation.php');
require_once('includes/chismy_nsfw.php');
